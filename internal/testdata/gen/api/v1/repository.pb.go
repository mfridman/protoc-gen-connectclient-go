...
func file_api_v1_repository_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_repository_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_v1_repository_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_v1_repository_proto_msgTypes[2].Exporter = func(v any, i int) any {
