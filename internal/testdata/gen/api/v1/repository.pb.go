...
var file_api_v1_repository_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x2a, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	...
	0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x22, 0xf0, 0x01, 0x0a, 0x0a,
	...
	0x72, 0x6c, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x61, 0x6d, 0x70, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0x61,
	0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x4c, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x6f, 0x72, 0x79, 0x12, 0x1c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65,
	...
	0x65, 0x42, 0xaa, 0x01, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31,
...
var file_api_v1_repository_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_api_v1_repository_proto_goTypes = []interface{}{
	(*GetRepositoryRequest)(nil),  // 0: api.v1.GetRepositoryRequest
	(*GetRepositoryResponse)(nil), // 1: api.v1.GetRepositoryResponse
	(*Repository)(nil),            // 2: api.v1.Repository
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_api_v1_repository_proto_depIdxs = []int32{
	2, // 0: api.v1.GetRepositoryResponse.repository:type_name -> api.v1.Repository
	3, // 1: api.v1.Repository.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: api.v1.Repository.updated_at:type_name -> google.protobuf.Timestamp
	0, // 3: api.v1.RepositoryService.GetRepository:input_type -> api.v1.GetRepositoryRequest
	1, // 4: api.v1.RepositoryService.GetRepository:output_type -> api.v1.GetRepositoryResponse
...
func file_api_v1_repository_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_repository_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_repository_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_repository_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
